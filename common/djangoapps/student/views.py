...
def _generate_activation_email_context(user, registration):
    """
...
def compose_and_send_activation_email(user, profile, user_registration=None):
    ...
    context = _generate_activation_email_context(user, user_registration)
...
def reactivation_email_for_user(user):
    ...
    try:
        context = _generate_activation_email_context(user, registration)
